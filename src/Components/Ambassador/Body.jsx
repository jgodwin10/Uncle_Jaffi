        ...
        <div className="pt-16 max-w-[894px] mx-auto space-y-[32px] md:space-y-[64px] text-center ">
          ...
          <div className="text-[#3F4045] md:text-base text-[14px] space-y-6">
            <p>
              ...
              Jaffi vibe as an Uncle Jaffi Influencer! This is your shot to get
              in with one of the coolest brands around.
            </p>
            <p>
            ...
            <p>
              Ready to make it official? Anyone can become an awesome Uncle
              Jaffi Influencer. Just fill out a few questions on our application
              form.
            </p>
          </div>
