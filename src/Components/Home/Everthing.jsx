...
const Everthing = () => {
  ...
  return (
    <div className="lg:px-[70px] px-6">
      <div className="  max-w-[1352px] mx-auto  py-12 md:py-20 ">
            ...
            <div className="md:text-[24px] text-[15px] gap-[24px] flex-col absolute top-0 left-0 w-full h-full text-white flex justify-center items-center">
              <div className={`text-center `}>
                ...
                >
                  ...
                  keep the atmosphere lively and engaging. With the best DJ in
                  the city and a schedule packed with fun activities, there's
                  never a dull moment at Uncle Jaffi's.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="md:text-[24px] text-[15px] gap-[24px] flex-col absolute top-0 left-0 w-full h-full text-white flex justify-center items-center">
              <div className={`text-center `}>
                ...
                >
                  ...
                  than just a restaurant—it's a hub for socializing,
                  celebrating, and enjoying life's best moments with friends and
                  family.
                </p>
              </div>
            </div>
