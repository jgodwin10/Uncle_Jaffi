...
const Menu = () => {
  return (
    <div className="md:px-[70px] px-6 py-8">
      ...
      <div className="grid md:py-[80px] py-10 gap-[36px] md:gap-[24px] md:grid-cols-3">
        <div className="flex flex-col items-center gap-[24px] ">
          <img
            className="xl:size-[380px] lg:size-[340px] md:size-[240px] shadow size-[280px] rounded-full object-cover"
            src={Img}
            alt=""
          />
        ...
        <div className="flex flex-col items-center gap-[24px] ">
          <img
            className="xl:size-[380px] lg:size-[340px] md:size-[240px] size-[280px] shadow rounded-full object-cover"
            src={Img1}
            alt=""
          />
