...
const About = () => {
  return (
    <div className="px-6 lg:px-[70px]">
      <div className="space-y-[24px] max-w-[1352px] mx-auto  py-20 gap-[20px] grid md:grid-cols-2">
        <img
        ...
        <div className="flex items-center">
          <div className="md:w-[614px] space-y-[26px] shadow py-[32px] px-[16px] xl:p-[20px] xl:h-[456px] bg-[#FAB939]">
            ...
            <p className="text-[#3F4045] lg:text-base text-[14px] leading-[24px]">
              ...
              your weekend. Please note that entry is strictly by reservation,
              so be sure to book your spot in advance. Don't miss out on the
              most exciting party in town—reserve your place today and let the
              good times roll at Uncle Jaffi's!
            </p>
