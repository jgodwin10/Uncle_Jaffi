    ...
    <div className="max-w-[1352px] py-16 mx-auto px-6">
      <div className="max-w-[912px] text-center space-y-[42px] mx-auto">
        ...
        <p className="leading-[24px] text-[#3F4045] md:text-base text-[14px]">
          ...
          eatery and has since grown into a beloved dining destination known for
          its warm hospitality and delicious cuisine. Our unique selling points
          include a vibrant and cozy ambience, an exceptional menu crafted from
          the freshest ingredients, and a dynamic entertainment lineup featuring
          the best local DJs and live music. What sets Uncle Jaffi's apart is
          our commitment to creating a memorable dining experience where great
          food, lively entertainment, and a welcoming atmosphere come together
          seamlessly.
        </p>
      </div>
      <div className="md:pt-24 pt-16 space-y-[36px] md:space-y-[56px]">
        ...
        <div className="pt-10 max-w-[912px] mx-auto space-y-[40px] text-center">
          ...
          <p className="text-[#3F4045] text-[14px] md:text-base">
            ...
            support and a proven business model. Contact us today to learn more
            and take the first step towards a rewarding business venture!
          </p>
